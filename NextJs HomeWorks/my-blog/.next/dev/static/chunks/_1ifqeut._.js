...
"[project]/app/apiTest/data:f374eb [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apiTest$2f$data$3a$f374eb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/apiTest/data:f374eb [app-client] (ecmascript) <text/javascript>");
;
    ...
    if ($[1] !== text) {
        t0 = ({
            "CreateNoteForm[add]": async ()=>{
                console.log(text);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$apiTest$2f$data$3a$f374eb__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["PostNotes"])(text);
            }
        })["CreateNoteForm[add]"];
        $[1] = text;
        $[2] = t0;
...
//# sourceMappingURL=_1ifqeut._.js.map